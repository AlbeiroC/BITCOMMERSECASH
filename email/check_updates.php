<?php
  ...
  if (!empty($_GET['FILTER_VALIDATE'])&&!empty($_GET['user'])) {
    $sql = "SELECT id FROM tokens WHERE token = '".$_GET['FILTER_VALIDATE']."' AND user = '".$_GET['user']."' AND type = 'update' LIMIT 1";
    if ($res=$con->query($sql)) {
      if ($res->num_rows>0) {

      }
      else{
        echo "Ha surgido un problema en el servidor y este mensaje fue enviado como fallido, por favor omitir este mensaje.";
        exit();
      }
    }
    else{
  ...
  $URL_TO_VALIDATE = ''.http().$_SERVER['HTTP_HOST'].'/register?FILTER_VAR_ACCTION='.$_GET['FILTER_VALIDATE'].'&closeUp='.date('Ymdhis').'&u='.$_GET['user'];
  ...
  $mensaje = "Has solicitado la actualización de tus datos personales, pero antes de proceder debes validar esta informacion siguiendo el enlace.";
  if (!empty($_GET['mensaje'])) {
    $mensaje = htmlspecialchars(urldecode($_GET['mensaje']), ENT_QUOTES);
  }
?>
      ...
      <tbody>
        <tr style="vertical-align: top">
          <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
            ...
            <div style="background-color:#DDDDE3;">
              <div style="Margin: 0 auto;min-width: 320px;max-width: 500px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: transparent;" class="block-grid two-up ">
                <div style="border-collapse: collapse;display: table;width: 100%;background-color:transparent;">
                  <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="background-color:#DDDDE3;" align="center"><table cellpadding="0" cellspacing="0" border="0" style="width: 500px;"><tr class="layout-full-width" style="background-color:transparent;"><![endif]-->
                    ...
                    <div style="background-color: transparent; width: 100% !important;">
                      ...
                      <div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:20px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">
                        ...
                        <div align="center" class="img-container center  autowidth  fullwidth " style="padding-right: 0px;  padding-left: 0px;">
                          ...
                          <a href="https://beefree.io" target="_blank"> <img class="center  autowidth  fullwidth" align="center" border="0" src="http://bitcommersecash.com/img/logo/logo_brand_inverse.png" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;width: 100%;max-width: 250px" width="250"> </a>
                    ...
                    <div style="background-color: transparent; width: 100% !important;">
                      ...
                      <div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:20px; padding-bottom:20px; padding-right: 0px; padding-left: 0px;">
                        ...
                        <div class="">
                          ...
                          <div style="color:#6E6F7A;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:150%; padding-right: 10px; padding-left: 10px; padding-top: 20px; padding-bottom: 20px;">
                            <div style="font-size:12px;line-height:18px;color:#6E6F7A;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;">
                              <div style="text-align: right; line-height:18px; font-size:12px;"><strong><span style="font-size: 16px; line-height: 24px;">Buenos negocios, con cuentas claras.</span></strong></div>
                            </div>
                          </div>
                          <!--[if mso]></td></tr></table><![endif]-->
                        </div>
                    ...
                    <div style="background-color: transparent; width: 100% !important;">
                      ...
                      <div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:0px; padding-bottom:0px; padding-right: 0px; padding-left: 0px;">
                        ...
                        <div class="">
                          ...
                          <div style="color:#ffffff;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:120%; padding-right: 0px; padding-left: 0px; padding-top: 30px; padding-bottom: 30px;">
                            <div style="font-size:12px;line-height:14px;color:#ffffff;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;">
                              <p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center"><strong><span style="font-size: 28px; line-height: 33px;">Datos Actualizados</span></strong></p>
                            </div>
                          </div>
                          <!--[if mso]></td></tr></table><![endif]-->
                        </div>
                        ...
                        <div align="center" class="img-container center  autowidth  " style="padding-right: 0px;  padding-left: 0px;">
                          <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px;line-height:0px;"><td style="padding-right: 0px; padding-left: 0px;" align="center"><![endif]-->
                          <a href="https://beefree.io" target="_blank"> <img class="center  autowidth " align="center" border="0" src="http://bitcommersecash.com/img/logo/icon_original.png" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;width: 100%;max-width: 400px" width="400"> </a>
                          <!--[if mso]></td></tr></table><![endif]-->
                        </div>
                        <!--[if (!mso)&(!IE)]><!-->
                      </div>
                      ...
                      <div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:30px; padding-bottom:30px; padding-right: 0px; padding-left: 0px;">
                        ...
                        <div class="">
                          ...
                          <div style="color:#ffffff;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:120%; padding-right: 10px; padding-left: 10px; padding-top: 25px; padding-bottom: 10px;">
                            <div style="font-size:12px;line-height:14px;color:#ffffff;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;">
                              <p style="margin: 0;font-size: 18px;line-height: 22px;text-align: center"><span style="font-size: 24px; line-height: 28px;"><strong>Cambios de información</strong></span></p>
                            </div>
                          </div>
                          <!--[if mso]></td></tr></table><![endif]-->
                        </div>
                        <div class="">
                          ...
                          <div style="color:#B8B8C0;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:150%; padding-right: 10px; padding-left: 10px; padding-top: 0px; padding-bottom: 10px;">
                            <div style="font-size:12px;line-height:18px;color:#B8B8C0;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;">
                              <p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center"><?php echo $mensaje; ?></p>
                            </div>
                          </div>
                          <!--[if mso]></td></tr></table><![endif]-->
                        </div>
                              ...
                              <tbody>
                                <tr style="vertical-align: top">
                                  <td align="left" valign="middle" style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                    <a href="https://www.facebook.com/bitcommercash" title="Facebook" target="_blank"> <img src="https://bitcommersecash.com/email/images/facebook.png" alt="Facebook" title="Facebook" width="32" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important"> </a>
                        ...
                        <div class="">
                          ...
                          <div style="color:#959595;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:150%; padding-right: 10px; padding-left: 10px; padding-top: 15px; padding-bottom: 10px;">
                            <div style="font-size:12px;line-height:18px;color:#959595;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;">
                              <p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center">Este correo electrónico es enviado por nuestro sistema automático, si has recibido este correo de manera errónea puedes omitirlo.</p>
                            </div>
                          </div>
                          <!--[if mso]></td></tr></table><![endif]-->
                        </div>
